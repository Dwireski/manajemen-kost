    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex-shrink-0">
                            <Link href={route('dashboard')} className="flex items-center gap-2">
                                ...
                                <span className="font-bold text-gray-800 text-lg hidden sm:block">Manajemen Kost</span>
                            </Link>
                        </div>
                        ...
                        <div className="hidden md:flex items-center space-x-1">
                            ...
                            <Link
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${isActive('kosts.*')
                                    ? 'bg-blue-50 text-blue-600'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${isActive('rooms.*')
                                    ? 'bg-blue-50 text-blue-600'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${isActive('tenants.*')
                                    ? 'bg-blue-50 text-blue-600'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${isActive('payments.*')
                                    ? 'bg-blue-50 text-blue-600'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                    }`}
                            >
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' md:hidden bg-white border-t border-gray-200'}>
                    <div className="pt-2 pb-3 space-y-1 px-4">
                        ...
                        <Link
                            href={route('kosts.index')}
                            className={`block px-3 py-2 rounded-md text-base font-medium ${isActive('kosts.*')
                                ? 'bg-blue-50 text-blue-600'
                                : 'text-gray-600 hover:bg-gray-50'
                                }`}
                        >
                        ...
                        <Link
                            href={route('rooms.index')}
                            className={`block px-3 py-2 rounded-md text-base font-medium ${isActive('rooms.*')
                                ? 'bg-blue-50 text-blue-600'
                                : 'text-gray-600 hover:bg-gray-50'
                                }`}
                        >
                        ...
                        <Link
                            href={route('tenants.index')}
                            className={`block px-3 py-2 rounded-md text-base font-medium ${isActive('tenants.*')
                                ? 'bg-blue-50 text-blue-600'
                                : 'text-gray-600 hover:bg-gray-50'
                                }`}
                        >
            ...
            {flashMessage && (
                <div className="fixed top-20 right-4 z-50 max-w-sm">
                    <div className={`px-4 py-3 rounded shadow-lg border ${flashType === 'success'
