            ...
            <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex-shrink-0">
                            ...
                            >
                                ...
                                <span className="font-bold text-gray-800 text-base sm:text-lg hidden sm:block">
                                    Manajemen Kost
                                </span>
                            </Link>
                        </div>
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <button className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
                ...
                <div
                    className={
                        ...
                        " md:hidden bg-white border-t border-gray-200 max-h-[calc(100vh-4rem)] overflow-y-auto"
                    }
                >
                    ...
                    <div className="pt-4 pb-3 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1 px-4">
                            <Link
                                ...
                                className="block px-3 py-2.5 rounded-md text-sm sm:text-base font-medium text-gray-600 hover:bg-gray-50"
                            >
                                Profile
                            </Link>
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="block w-full text-left px-3 py-2.5 rounded-md text-sm sm:text-base font-medium text-gray-600 hover:bg-gray-50"
                            >
                                Log Out
                            </Link>
                        </div>
