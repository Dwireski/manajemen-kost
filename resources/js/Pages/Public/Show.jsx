                ...
                <div className="relative h-96 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                        <div className="max-w-7xl mx-auto">
                            ...
                            <p className="text-xl flex items-center gap-2 drop-shadow-lg">
                                <svg
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                                    <div className="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center text-green-600 text-2xl flex-shrink-0">
                                        📱
                                    </div>
                                    <div>
                                        <p className="text-xs text-gray-500">
                            ...
                            <div className="space-y-4">
                                <a
                                    ...
                                    className="flex items-center justify-center gap-3 w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-4 rounded-xl transition shadow-sm text-lg"
                                >
                                    <svg
                                        className="w-6 h-6"
                                        fill="currentColor"
                                ...
                                <a
                                    ...
                                    className="flex items-center justify-center gap-3 w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-4 rounded-xl transition shadow-sm text-lg"
                                >
                                    <svg
                                        className="w-6 h-6"
                                        fill="none"
